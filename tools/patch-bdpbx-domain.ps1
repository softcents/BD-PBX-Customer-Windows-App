...
#define IDD_ACCOUNT_OFFSET_CUSTOM_LINK 319
#define IDD_ACCOUNT_OFF_FINAL 338
...
RTEXT           "Display Name", IDC_STATIC, 7, 100, 70, 8, SS_WORDELLIPSIS
EDITTEXT        IDC_EDIT_DISPLAYNAME, 86, 97, 127, 14, ES_AUTOHSCROLL
CONTROL         "<a>?</a>", IDC_SYSLINK_NAME, "SysLink", 0x0, 222, 99, 7, 8
RTEXT           "Voicemail Number", IDC_STATIC, 7, 119, 70, 8, SS_WORDELLIPSIS
EDITTEXT        IDC_EDIT_VOICEMAIL, 86, 116, 127, 14, ES_AUTOHSCROLL
CONTROL         "<a>?</a>", IDC_SYSLINK_VOICEMAIL, "SysLink", 0x0, 222, 118, 7, 8
RTEXT           "Dialing Prefix", IDC_STATIC, 7, 138, 70, 8, SS_WORDELLIPSIS
EDITTEXT        IDC_ACCOUNT_DIALING_PREFIX, 86, 135, 127, 14, ES_AUTOHSCROLL
CONTROL         "<a>?</a>", IDC_ACCOUNT_HELP_DIALING_PREFIX, "SysLink", 0x0, 222, 137, 7, 8
RTEXT           "Dial Plan", IDC_STATIC, 7, 157, 70, 8, SS_WORDELLIPSIS
EDITTEXT        IDC_ACCOUNT_DIAL_PLAN, 86, 154, 127, 14, ES_AUTOHSCROLL
CONTROL         "<a>?</a>", IDC_ACCOUNT_HELP_DIAL_PLAN, "SysLink", 0x0, 222, 156, 7, 8
CONTROL         "Hide Caller ID", IDC_ACCOUNT_HIDE_CID, "Button", BS_AUTOCHECKBOX | WS_TABSTOP, 86, 174, 127, 10
CONTROL         "<a>?</a>", IDC_ACCOUNT_HELP_HIDE_CID, "SysLink", 0x0, 222, 173, 7, 8
RTEXT           "Media Encryption", IDC_STATIC, 7, 193, 70, 8, SS_WORDELLIPSIS
COMBOBOX        IDC_SRTP, 86, 190, 127, 30, CBS_DROPDOWNLIST | WS_VSCROLL | WS_TABSTOP
CONTROL         "<a>?</a>", IDC_SYSLINK_ENCRYPTION, "SysLink", 0x0, 222, 192, 7, 8
RTEXT           "Transport", IDC_STATIC, 7, 212, 70, 8, SS_WORDELLIPSIS
COMBOBOX        IDC_TRANSPORT, 86, 209, 127, 30, CBS_DROPDOWNLIST | WS_VSCROLL | WS_TABSTOP
CONTROL         "<a>?</a>", IDC_SYSLINK_TRANSPORT, "SysLink", 0x0, 222, 211, 7, 8
RTEXT           "Public Address", IDC_STATIC, 7, 231, 70, 8, SS_WORDELLIPSIS
COMBOBOX        IDC_PUBLIC_ADDR, 86, 228, 127, 30, CBS_DROPDOWN | WS_VSCROLL | WS_TABSTOP
CONTROL         "<a>?</a>", IDC_SYSLINK_PUBLIC_ADDRESS, "SysLink", 0x0, 222, 230, 7, 8
RTEXT           "Register Refresh", IDC_STATIC, 7, 269, 70, 8, SS_WORDELLIPSIS
EDITTEXT        IDC_ACCOUNT_REGISTER_REFRESH, 86, 266, 30, 14, ES_AUTOHSCROLL
RTEXT           "Keep-Alive", IDC_STATIC, 116, 269, 70, 8, SS_WORDELLIPSIS
EDITTEXT        IDC_ACCOUNT_KEEP_ALIVE, 191, 266, 20, 14, ES_AUTOHSCROLL
CONTROL         "Publish Presence", IDC_PUBLISH, "Button", BS_AUTOCHECKBOX | WS_TABSTOP, 86, 289, 127, 10
CONTROL         "<a>?</a>", IDC_SYSLINK_PUBLISH_PRESENCE, "SysLink", 0x0, 222, 287, 7, 8
CONTROL         "Allow IP Rewrite", IDC_REWRITE, "Button", BS_AUTOCHECKBOX | WS_TABSTOP, 86, 301, 127, 10
CONTROL         "<a>?</a>", IDC_SYSLINK_REWRITE, "SysLink", 0x0, 222, 299, 7, 8
CONTROL         "ICE", IDC_ICE, "Button", BS_AUTOCHECKBOX | WS_TABSTOP, 86, 313, 127, 10
CONTROL         "<a>?</a>", IDC_SYSLINK_ICE, "SysLink", 0x0, 222, 311, 7, 8
CONTROL         "Disable Session Timers", IDC_SESSION_TIMER, "Button", BS_AUTOCHECKBOX | WS_TABSTOP, 86, 325, 127, 10
CONTROL         "<a>?</a>", IDC_SYSLINK_SESSION_TIMER, "SysLink", 0x0, 222, 323, 7, 8
