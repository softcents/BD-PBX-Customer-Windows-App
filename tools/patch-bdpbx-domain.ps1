...
$cpp = [regex]::Replace($cpp, 'm_Account\.server\.IsEmpty\(\)\s*\|\|\s*m_Account\.username\.IsEmpty\(\)', 'm_Account.server.IsEmpty() ||`r`n`t`t m_Account.username.IsEmpty() ||`r`n`t`t m_Account.password.IsEmpty()', 1)
